/*
    This module is used to add some glitter to the teacher`s page.
    Nothing special here, only manipulations with HTML, to make page more smooth (like SPA, but not spa (CC HTMX))
*/
